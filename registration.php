...
<html>
    ...
    <body>
        ...
        <div class="container">
           ...
           <form class="form-horizontal" method="post" action="reg.php" enctype="multipart/form-data" onSubmit="alert('Thank you for registering.');">
              ...
              <div class="form-group" style="color:#ff3333">
                  ...
                  <select class="form-control" name="bg" required>
                    ...
                    <div class="form-group" style="color:#ff3333">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="weights in kgs" name="bw" required>
                      </div>
                   </div>
                     <div class="form-group" style="color:#ff3333">
                  ...
                  <select class="form-control" name="state" required>
                    ...
                    <div class="form-group" style="color:#ff3333">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="Insert Area" name="area" required>
                      </div>
                   </div>
                    <div class="form-group" style="color:#ff3333">
                        <label class="control-label col-sm-2">Address</label>
                        <div class="col-sm-6">          
                        <input type="text" class="form-control" style="width:550px;height:105px;" placeholder="Full Address"name="address" required>
                        </div>
                    </div>
                      <div class="form-group" style="color:#ff3333">
                  ...
                  <div class="col-sm-6">
                  <select class="form-control" name="nd" required>
               ...
               <div class="form-group" style="color:red">
                      <div class="col-sm-9" style="margin-left: 193px;">  
                          <input type="checkbox"  name="d1" value="donation" required> I have read the eligibility criteria  and confirm  that i am  eligible to donate blood.<br>
                          <input type="checkbox"  name="d2" value="donation" required> I agree to the Term  and Conditions   and consent  to have  my contact  and donor  information published  to the  potential blood  recipients.
                      </div>
                  </div>
                  <div class="form-group">
